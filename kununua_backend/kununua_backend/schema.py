...
from products.queries import ProductsQuery as SchemeProductsQuery, CategoriesQuery as SchemeCategoriesQuery, CartQuery as SchemeCartQuery, FilterQuery as SchemeFilterQuery
from products.mutations import ProductsMutation as SchemeProductsMutation

class KununuaQuery(SchemeAuthenticationQuery, SchemeProductsQuery, SchemeCategoriesQuery, SchemeCartQuery, SchemeFilterQuery, graphene.ObjectType):
  pass
