...
class ProductScraped(object):
    ...
    def __init__(self, name=None, price=None, brand=None, image=None, offer_price=None, 
                 weight=None, is_vegetarian=False, is_gluten_free=False, 
                 is_freezed=False, is_from_country=False, is_eco=False, 
                 is_without_sugar=False, is_without_lactose=False, category=None, 
                 supermarket=None):
        ...
        if weight is not None and type(weight) is not str:
            raise ValueError("Product weight must be None or string")
    ...
    def __str__(self):
        return f"Product[name: {self.name}, price: {self.price}, brand: {self.brand}, offer_price: {self.offer_price}, weight: {self.weight}, category: {self.category.name}, supermarket: {self.supermarket.name}]"